        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">계정을 선택해 주세요</p>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <button
                ...
                disabled={isLoading}
                className="w-full flex justify-center items-center px-6 py-4 bg-white hover:bg-gray-50 text-gray-900 rounded-xl font-medium transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none border border-gray-300 shadow-sm"
              >
                {isLoading ? (
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-sm text-gray-600 text-center mb-4 font-medium">승인된 계정</p>
              <div className="space-y-3">
                {authorizedEmails.map((item) => (
                  ...
                  >
                    ...
                    <span className={`ml-3 px-3 py-1 rounded-full text-xs font-medium ${item.color}`}>
                      {item.role}
                    </span>
                  </div>
                ))}
